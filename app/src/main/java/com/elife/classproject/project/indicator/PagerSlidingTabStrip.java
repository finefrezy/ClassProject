...
package com.elife.classproject.project.indicator;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private float selectedTabTextSize = 15;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		// 转变为标准尺寸的一个函数 COMPLEX_UNIT_DIP是单位，scrollOffset是数值，也就是scrollOffset dip
